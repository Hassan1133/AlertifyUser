...
public class EditUserProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createProfileLoadingDialog() {
        ...
        profileLoadingDialog.setContentView(R.layout.loading_dialog);
        ...
        TextView loadingText = profileLoadingDialog.findViewById(R.id.loading);
        loadingText.setText("Loading Profile.....");
